...
|---|---:|---|---|
| Phase 1 | 4 weeks | Setup, LLM mechanics, tokenization, structured outputs | API healthcheck, tokenizer demo, prompt module |
| Phase 2 | 5 weeks | Embeddings, retrieval, RAG | Retrieval service, cited Q&A bot |
...
| Phase 6 | 3 weeks | AI infra light | LLM router/gateway |
| Phase 7 | 2 weeks | Security and prompt injection | Injection test suite |
| Phase 8 | 4-6 weeks | Capstone polish and job prep | Portfolio, applications, interview prep |
...
| Week | Focus | Output |
|---|---|---|
| 1 | Tracks 00-01 | Workspace and LLM playground |
| 2 | Track 02 | Prompt regression harness |
| 3 | Track 03 | Semantic search service |
| 4 | Track 04 | RAG assistant |
| 5 | Track 05 | Eval and observability layer |
| 6 | Track 06 | Tool-using agent |
| 7 | Tracks 07-09 | Architecture, infra, security docs |
| 8 | Track 10 | One minimum-complete capstone and job materials |
...
| Week | Focus | Output |
|---|---|---|
| 1 | Orientation | Workspace, build log, API smoke test |
| 2 | LLM mechanics | Token and model behavior playground |
| 3 | Context engineering | Prompt specs and regression tests |
| 4 | Embeddings | Semantic search baseline |
| 5 | Retrieval quality | Chunking, filters, hybrid search |
| 6 | RAG | Grounded assistant with citations |
...
| 10 | Agents | Tool-calling workflow agent |
| 11 | Systems, infra, security | Architecture and red-team reports |
| 12 | Capstone | Demo, README, resume bullets, mock interview |
...
If you are short on time, cut passive watching before cutting evals. The eval habit is what separates AI engineering from prompt tinkering.
